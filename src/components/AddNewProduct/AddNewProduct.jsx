...
import { addNewProduct } from "../../redux/pharmacy/pharmacyOps";
      ...
      <div className={css.addNewProductContainer}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className={css.form}>
          ...
          <div className={css.buttons}>
            <button type="submit" className={css.addButtons}>Add</button>
            <button type="button" onClick={onRequestClose} className={css.cancelButtons}>
              Cancel
            </button>
          </div>
        </form>
